                ...
                <b-col md="6">
                  ...
                  <div class="card">
                      ...
                      <div class="small-box">
                          ...
                          <div>
                              <h3>{{Number(auth_data.e_money).toLocaleString()}}</h3>
                              <p class="">E Money</p>
                          </div>
                ...
                >
                    ...
                    <table class="table table-striped table-lg mb-0 requests-table">
                        ...
                        >
                            ...
                            <td>{{row.e_money_amount_deducted != null?Number(row.e_money_amount_deducted).toLocaleString():'0'}}</td>
                            <td>
                            <b-badge
