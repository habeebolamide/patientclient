                    ...
                    <div class="row bg-isnfo">
                        <div class="border-right col-md-9 col-12">
                            ...
                            <div class="table-responsive mt-4">
                                <table v-if="nestedSubCategories.length" class="table table-hover table-sm mb-0 requests-table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr v-for="(cat, i) in nestedSubCategories" :key="i">
                                            <td>
                                                {{i+1}}
                                            </td>
                                            <td>
                                                ...
                                                >
                                                    ...
                                                    <v-list>
                                                        <v-list-item>
                                                            ...
                                                            @click="$bvModal.show('manage');current=cat"
                                                            
                                                            >
                                                            <i class="mdi mdi-square-edit-outline mr-1"></i> Manage nestedSubcategories
                                                            </v-list-item-title>
                                                        </v-list-item>
                                                        <v-list-item>
                                                            <v-list-item-title
                        ...
                        <div class="col-md-3 col-12" md="5">
                            <form @submit.prevent="editing ? update() : save()">
                                ...
                                <v-col
                                    ...
                                    >
                                    <p class="mb-0 text-danger" v-if="errorMssg.name">{{errorMssg.name[0]}}</p>
                                    <v-text-field
...
export default {
    ...
    methods:{
        ...
        fetchData(page=1) {
            ...
            this.$api
            .post(this.dynamic_route('/nested-sub-category/sub-category/' + this.data.id), {filters:this.filters})
            .then(res => {
                
                this.nestedSubCategories = res.data.data
        ...
        save() {
            ...
            this.form.sub_category_id=this.data.id
            this.$api
            .post(this.dynamic_route('/nested-sub-category'), this.form)
            .then(res => {
        ...
        update() {
            this.$api
            .patch(this.dynamic_route('/nested-sub-category/' + this.form.id), this.form)
            .then(res => {
        ...
        deleteSubcat(id) {
          ...
          this.$api
          .delete(this.dynamic_route('/nested-sub-category/'+id))
          .then(res => {
          ...
          .catch(err => {
              ...
              this.$toasted.error('Unable to delete Nested Subcategory!', {
                action: {
                text: 'Close',
                    onClick: (e, toastObject) => {
                        toastObject.goAway(0);
